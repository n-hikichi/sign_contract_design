...
namespace api {
    ...
    // };
    export const postApprovalUrl = async (agreementId: string, body: object): Promise<Response> => {
        const requestOptions = {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', ...getAuthorizationHeader() },
            body: JSON.stringify(body),
    ...
    // ----- ★検証中機能★ -----
    // 
    export const getRepresentativeSeal = async (type: string): Promise<Response> => {
        return await fetch(apiURL.CONCLUDEDAGREEMENT_URL + '/' + type, getRequestOptions());
    };
    export const getConcludedRepresentativeSealImage = async (agreementId: string): Promise<Response> => {
        return await fetch(apiURL.CONCLUDED_REPRESENTATIVE_SEAL_URL + '?agreement_id=' + agreementId, getRequestOptions());
    };
    export const getApprovalFlowList = async (companyId: string): Promise<Response> => {
        return await fetch(apiURL.APPROVALFLOWLIST_URL + '?company_id=' + companyId, getRequestOptions());
    };
    export const getApprovalFlow = async (companyId: string, workflowId: string, workflowType: string): Promise<Response> => {
        return await fetch(apiURL.APPROVALFLOW_URL + '/' + companyId + '/workflows?workflow_id=' + workflowId + '&workflow_type=' + workflowType, getRequestOptions());
    };
    // '?company_id=' + companyId

    export const postApprovalFlow = async (body: object): Promise<Response> => {
        const requestOptions = {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', ...getAuthorizationHeader() },
            body: JSON.stringify(body),
        };
        return await fetch(apiURL.APPROVALFLOW_URL, requestOptions);
    };
    export const getRepresentativeSealImage = async (companyId: string, workflowId: string): Promise<Response> => {
        return await fetch(apiURL.REPRESENTATIVE_SEAL_URL + '?company_id=' + companyId + '&workflow_id=' + workflowId, getRequestOptions());
    };
    export const deleteWorkflowData = async (companyId: string, workflowId: string): Promise<Response> => {
        const requestOptions = {
            method: 'DELETE',
            headers: { ...getAuthorizationHeader() },
        };
        return await fetch(apiURL.APPROVALFLOW_URL + '?company_id=' + companyId + '&workflow_id=' + workflowId, requestOptions);
    };
    export const putWorkflowData = async (companyId: string, workflowId: string, body: object): Promise<Response> => {
        const requestOptions = {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json', ...getAuthorizationHeader() },
            body: JSON.stringify(body),
     ...
     * @returns レスポンス
     */
    export const postAgreementRemandForGuest = async (agreementId: string, body: object): Promise<Response> => {
        const requestOptions = {
            method: 'POST',
            headers: { 'Content-Type': 'application/json', ...getAuthorizationHeader() },
            body: JSON.stringify(body),

...
import DiscardSignatureHistory from './DiscardSignatureHistory';
            ...
            <>
                <Box sx={{ ...basePageStyle, backgroundColor: '#ffeeee' }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                        <CssBaseline />
                        <DiscardSignatureHistory approveFlowData={approveFlowData} approveResult={approveResult} agreement_id={selectedInfo.agreement_id} title={selectedInfo.title} own_company={selectedInfo.own_company.company_name} customer_company={selectedInfo.customer_company.company_name} />
                        <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%' }} >
                            <Box sx={{ display: 'flex', flexDirection: 'column', paddingBottom: '10px', paddingTop: '50px', width: '90%', marginLeft: '5%', marginRight: '5%' }} px={4}>
                                <Box sx={{ bgcolor: '#ffeeee', width: '100%', display: 'flex', justifyContent: 'flex-start', marginBottom: '5px' }}>
                                    ...
                                    {/* <Button variant="contained" color="success" onClick={(() => navigate('/documentManagement/conclusionDocument'))} sx={{ marginLeft: '10px', width: '150px', '&:hover': { backgroundColor: 'darkgreen' } }}>契約書を作成する</Button> */}
                                </Box>
                                ...
                                <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                    <Box sx={{ bgcolor: '#ffeeee', width: '100%', display: 'flex', justifyContent: 'flex-end', marginBottom: '5px' }}>
...
export default DiscardDocumentPage;
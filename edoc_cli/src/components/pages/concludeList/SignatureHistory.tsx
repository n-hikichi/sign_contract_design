...
const OpenedSideMenu: any = (props: any) => {
    ...
    return (
        ...
        >
            ...
            {/* <Box sx={{ marginBottom: '70px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <DrawerFooter>
                    <PDFDownloadLink document={<SignatureHistoryPdf approveFlowData={props.approveFlowData} approveResult={approveUserList} agreement_id={props.agreement_id} title={props.title} />} fileName={`signature_report_${props.title}_${converter.getCurrentDate()}`}>
...
const SignatureHistory: any = (props: any) => {

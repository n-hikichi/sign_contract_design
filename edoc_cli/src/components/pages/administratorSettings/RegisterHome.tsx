...
import { Accordion, AccordionDetails, AccordionSummary, Box, Button, CssBaseline, FormControl, InputAdornment, InputLabel, MenuItem, Modal, Radio, RadioGroup, Select, SelectChangeEvent, TextField, Typography } from '@mui/material';
...
import CustomPulldownMenu, { contractType, CustomPulldownMenu_ForPrefecture, effectiveDate, representativeSealSelectType } from '../../elements/CustomPulldownMenu';
...
import { PreviewApproveFlow_forNotifier, PreviewApproveFlowForRegister } from '../common/PreviewApproveFlow';
...
const RegisterHome: React.FC<{}> = () => {
     ...
     *
     * 自社代表者：代表者印アップロード
     * 2025年6月時点では代表者印のアップロード機能は搭載していない
     *
     */
    ...
    const handleCheckboxChange_internalPic = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!event.target.checked) {
            ...
            setSelectedInternalSeal(''); // 直近で選択されていた代表者印の印影
    ...
    const handleCheckboxChange_customerPic = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (!event.target.checked) {
            ...
            setSelectedCustomerSeal(''); // 直近で選択されていた代表者印の印影
    ...
    // 代表者印選択 ラジオボタンが操作された際に、代表者印が登録されていたら設定する

/**
 * ModernRegisterHome - モダナイズされた契約書登録画面
 *
 * MUI v6 + Tailwind CSS ハイブリッドスタイリング
 * ModernPageLayoutでラップし、既存のAccordion構造を維持
 */
...
import CustomPulldownMenu, {
  contractType,
  CustomPulldownMenuForPrefecture,
  CustomPulldownMenuSignTemplate,
  effectiveDate,
  representativeSealSelectType,
} from '../../../components/elements/CustomPulldownMenu';
import { readOnlyTextFieldPaddingLessStyle } from '../../../styles/fontStyles';
import {
  baseTextFieldStyle,
  parentTextFieldStyle,
  registerHomeInputErrorDialogStyle,
} from '../../../styles/styles';
...
import ModernPageLayout from '../../templates/ModernPageLayout';
import { PreviewApproveFlowForRegister, PreviewApproveFlowForNotifier } from '../common/PreviewApproveFlow';
...
const ModernRegisterHome: React.FC = () => {
...
export default ModernRegisterHome;
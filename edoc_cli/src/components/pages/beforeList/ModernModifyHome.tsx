/**
 * ModernModifyHome - モダナイズされた契約書修正画面
 *
...
const ModernModifyHome: React.FC = () => {
    ...
    return (
        <>
            <ModernPageLayout
                loading={isLoading}
                title="契約書修正"
                subtitle="契約書情報を更新してください"
                breadcrumbs={[
                    { label: '承認前契約書', path: '/documentManagement/registerList' },
                    { label: '契約書修正' },
                ]}
            >
                {!isPreviewVisible && (
...
export default ModernModifyHome;
...
const RegisterTopIt: React.FC<{}> = () => {
    ...
    const goNextPage = async () => {
        navigate('/documentManagement/registerItDocument', { state: { internalInfo, selectedValue, selectedCompanyData, signTemplateList } });
    }

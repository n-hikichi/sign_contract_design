        ...
        >
            ...
            <Box sx={{ height: 'calc(100vh - 130px)', overflow: 'auto' }}>
                <List>
                    ...
                    <Box sx={{ width: '100%', paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px' }}>
                        <Typography component="div" fontWeight="bold" fontSize="1.3em" sx={{ borderBottom: '2px solid black', color: '#0D47A1' }}>契約書管理</Typography>
                        <Typography component="div">
                            ...
                            <Link to='/documentManagement/conclusionDocument'>
                                <ListItem key='締結済み契約書' sx={getLinkStyle(['/documentManagement/conclusionDocument'])}>
                                    <ListItemIcon><Description sx={{ color: getLinkStyle(['/documentManagement/conclusionDocument']).color }} /></ListItemIcon>
                                    <ListItemText primary='締結済み契約書' sx={{ color: getLinkStyle(['/documentManagement/conclusionDocument']).color }} primaryTypographyProps={{ fontWeight: 'bold' }} />
                                </ListItem>
                            </Link>
                            {/* <Link to='/documentManagement/conclusionDocument'>
                                <ListItem key='契約書管理' sx={getLinkStyle(['/documentManagement/conclusionDocument_'])}>
                                    <ListItemIcon><Description sx={{ color: getLinkStyle(['/documentManagement/conclusionDocument_']).color }} /></ListItemIcon>
                                    <ListItemText primary='契約書管理' sx={{ color: getLinkStyle(['/documentManagement/conclusionDocument_']).color }} primaryTypographyProps={{ fontWeight: 'bold' }} />
                                </ListItem>
                            </Link> */}
                            {/* <Link to='/documentManagement/expired'>
                                <ListItem key='失効済み契約書' sx={getLinkStyle(['/documentManagement/expired'])}>
                                    <ListItemIcon><Description sx={{ color: getLinkStyle(['/documentManagement/expired']).color }} /></ListItemIcon>
                                    <ListItemText primary='失効済み契約書' sx={{ color: getLinkStyle(['/documentManagement/expired']).color }} primaryTypographyProps={{ fontWeight: 'bold' }} />
                                </ListItem>
                            </Link> */}
                            {/* 不要 */}
                    ...
                    <Box sx={{ width: '100%', paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px' }}>
                        <Typography component="div" fontWeight="bold" fontSize="1.3em" sx={{ borderBottom: '2px solid black', color: '#0D47A1' }}>新規契約書管理</Typography>
                        <Typography component="div">
                            <Link to='/documentManagement/register'>
                                <ListItem key='登録' sx={getLinkStyle(['/documentManagement/register'])}>
                                    <ListItemIcon><UploadFileIcon sx={{ color: getLinkStyle(['/documentManagement/register']).color }} /></ListItemIcon>
                                    <ListItemText primary='登録' sx={{ color: getLinkStyle(['/documentManagement/register']).color }} primaryTypographyProps={{ fontWeight: 'bold' }} />
                                </ListItem>
                            </Link>
                            {loginUser === 'd.arai@micros.co.jp' && (
                                <Link to='/generativeai/registerIt'>
                                    <ListItem key='登録（IT企業特化）' sx={getLinkStyle(['/generativeai/registerIt'])}>
                                        <ListItemIcon><UploadFileIcon sx={{ color: getLinkStyle(['/generativeai/registerIt']).color }} /></ListItemIcon>
                                        <ListItemText primary='登録（IT企業特化）' sx={{ color: getLinkStyle(['/generativeai/registerIt']).color }} primaryTypographyProps={{ fontWeight: 'bold' }} />
                                    </ListItem>
                                </Link>
                            )}
                            <Link to='/documentManagement/registerList'>
                                <ListItem key='承認フロー開始前' sx={getLinkStyle(['/documentManagement/registerList'])}>
                                    <ListItemIcon><NotStartedIcon sx={{ color: getLinkStyle(['/documentManagement/registerList']).color }} /></ListItemIcon>
                                    <ListItemText
                                        primary={
                                            <Box display="flex" justifyContent="space-between" width="100%">
                                                <span>承認フロー開始前</span>
                                                <span style={{ color: 'red', backgroundColor: 'white', paddingLeft: '7px', paddingRight: '7px' }}>{agreement_Data?.before_flow ?? ''}</span>
                                            </Box>
                                        }
                                        sx={{ color: getLinkStyle(['/documentManagement/registerList']).color }}
                                        primaryTypographyProps={{ fontWeight: 'bold' }}
                                    />
                                </ListItem>
                            </Link>
                            <Link to='/documentManagement/internalDocument'>
                                <ListItem key='社内承認中' sx={getLinkStyle(['/documentManagement/internalDocument'])}>
                            ...
                            <Link to='/documentManagement/customerDocument'>
                                <ListItem key='相手方承認中' sx={getLinkStyle(['/documentManagement/customerDocument'])}>
                                    <ListItemIcon><PendingIcon sx={{ color: getLinkStyle(['/documentManagement/customerDocument']).color }} /></ListItemIcon>
                                    <ListItemText
                                        primary={
                                            <Box display="flex" justifyContent="space-between" width="100%">
                                                <span>相手方承認中</span>
                                                <span style={{ color: 'red', backgroundColor: 'white', paddingLeft: '7px', paddingRight: '7px' }}>{agreement_Data?.in_customer_flow ?? ''}</span>
                                            </Box>
                                        }
                                        sx={{ color: getLinkStyle(['/documentManagement/customerDocument']).color }}
                                        primaryTypographyProps={{ fontWeight: 'bold' }}
                                    />
                                </ListItem>
                            </Link>
                    ...
                    <Box sx={{ width: '100%', paddingLeft: '20px', paddingRight: '20px', paddingTop: '30px' }}>
                        <Typography component="div" fontWeight="bold" fontSize="1.3em" sx={{ borderBottom: '2px solid black', color: 'darkgreen' }}>企業・ユーザー管理</Typography>
                        <Typography component="div">
                            <Link to='/manage/company'>
                                <ListItem key='自社情報管理' sx={getLinkStyleForSettings(['/manage/company'])}>
                                    <ListItemIcon><PersonIcon sx={{ color: getLinkStyleForSettings(['/manage/company']).color }} /></ListItemIcon>
                                    <ListItemText primary='自社情報管理' sx={{ color: getLinkStyleForSettings(['/manage/company']).color }} primaryTypographyProps={{ fontWeight: 'bold' }} />
                                </ListItem>
                            </Link>
                            <Link to='/manage/clientCompany'>
                                <ListItem key='相手方情報管理' sx={getLinkStyleForSettings(['/manage/clientCompany', '/manage/clientCompanyLocation'])}>
                                    <ListItemIcon><Group sx={{ color: getLinkStyleForSettings(['/manage/clientCompany', '/manage/clientCompanyLocation']).color }} /></ListItemIcon>
                                    <ListItemText primary='相手方情報管理' sx={{ color: getLinkStyleForSettings(['/manage/clientCompany', '/manage/clientCompanyLocation']).color }} primaryTypographyProps={{ fontWeight: 'bold' }} />
                                </ListItem>
                            </Link>
                        </Typography>
                    </Box>
